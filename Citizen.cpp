...
void Citizen::setTransportStrategy(TransportStrategy* strategy) {
	// TODO - implement Citizen::setTransportStrategy
	throw "Not yet implemented";
}

bool Citizen::canTravel() {
	// TODO - implement Citizen::canTravel
	throw "Not yet implemented";
}

void Citizen::travel() {
	// TODO - implement Citizen::travel
	throw "Not yet implemented";
}
